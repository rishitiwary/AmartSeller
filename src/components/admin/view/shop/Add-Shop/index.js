              ...
              <form>
                <div className="row">
                  <label className="col-md-2 col-form-label">
                    Shop Name<span className="text-danger text-danger">*</span>
                  </label>
                ...
                <div className="row">
                  <label className="col-md-2 col-form-label">Shop Phone</label>
                  <div className="col-md-10">
                    <input
                      type="number"
                      className="form-control mb-3"
                ...
                <div className="row">
                  <label className="col-md-2 col-form-label">
                    City <span className="text-danger text-danger">*</span>
                  </label>
                  <div className="col-md-10">
                    <input
                      type="text"
