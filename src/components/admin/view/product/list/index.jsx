...
export default class List extends Component {
  ...
  async handlProductVarientDelete(id) {
    swal({
      title: "Are you sure?",
  ...
  async deleteProduct(id) {
    swal({
      title: "Are you sure?",
      text: "You want to delete Main product",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then(async (success) => {
      if (success) {
        let value = await GetProductDetails.getMainProductDelete(id);
        if (value) {
          window.location.reload();
        }
      }
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row justify-content-between">
          ...
          <div className="col-lg-6 col-md-6 ">
            <div className="bulk-section mt-30 float-right">
              <a href="/admin/product/discount" className="add-btn hover-btn">
                Discount
              </a>
            </div>
          </div>
                  ...
                  <table className="table ucp-table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th className="text-center">Common Name</th>
                        <th>Product</th>
                        <th>PubilshStatus</th>
                        <th>Action</th>
                      </tr>
                            ...
                            <tr key={i}>
                                        ...
                                        <td>
                                          <td className="action-btns">
                                            <Typography
                                              ...
                                              onClick={(e) =>
                                                this.handlProductVarientDelete(
                                                  row.id
                                                )
                                              }
                                            >
                              ...
                              <td>
                                <td className="action-btns">
                                  ...
                                  <Typography
                                    className={
                                      !d.ProductVariants.length
                                        ? "delete-btn"
                                        : "d-none"
                                    }
                                    onClick={(e) => this.deleteProduct(d.id)}
                                  >
                                    <i className="fas fa-trash-alt" />
                                  </Typography>
                                </td>
